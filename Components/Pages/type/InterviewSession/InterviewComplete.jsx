...
export const InterviewComplete = () => (
  <div className="flex flex-col items-center justify-center min-h-[60vh] gap-6 p-6 text-center animate-in zoom-in-95 duration-500">
    ...
    <MainText className="text-ui-textMuted max-w-lg">
      Your responses have been successfully submitted and your session is now closed. 
      Your report is being generated and will be available in your dashboard soon.
    </MainText>
    <MainButton 
