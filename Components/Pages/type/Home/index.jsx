        ...
        <div className="container mx-auto">
          <div className="flex justify-between items-end mb-10">
            <div>
              ...
              <MainText tag="p" title={get(latestJobs, "subtitle")} className="text-ui-textMuted dark:text-ui-muted font-medium" />
            </div>
          </div>
        ...
        <div className="container mx-auto bg-light-blue50/50 dark:bg-dark-primary-3/30 rounded-[2.5rem] p-8 md:p-16 border border-light-blue100/50 dark:border-ui-border backdrop-blur-sm">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <MainText tag="p" title={get(redefining, "desc")} className="text-ui-textMuted dark:text-ui-muted mb-8 leading-relaxed text-lg" />
              <div className="space-y-4 mb-10">
                {map(bullets, (bullet, index) => (
                  <div key={index} className="flex items-center gap-3">
                    <CheckCircle2 className="w-5 h-5 text-light-secondary dark:text-brand-accent flex-shrink-0" />
