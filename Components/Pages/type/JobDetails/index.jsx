...
const JobDetailsContent = ({ jobId }) => {
  ...
  if (error) return <JobDetailsError error={error} />;
  ...
  return (
    <div className="min-h-screen bg-light-primary dark:bg-dark-primary-1 py-12 px-4 sm:px-6 lg:px-8 font-sans transition-colors duration-200">
      <div className="max-w-6xl mx-auto">
        <MainButton onClick={navigateBack} className="flex items-center gap-2 text-sm font-medium text-ui-textMuted dark:text-ui-muted hover:text-ui-textMain dark:hover:text-white mb-6 transition-colors" icon={backIcon} title={"Back to Jobs"} />
