...
const ForgetPasswordPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-dark-primary-1 px-4 py-12">
      <div className="w-full max-w-lg bg-dark-primary-3 rounded-2xl shadow-2xl p-8 md:p-12 border border-blue-500/10 backdrop-blur-sm">
        <div className="text-center mb-10">
          ...
          <MainText
            ...
            className="text-dark-gray text-sm leading-relaxed max-w-[280px] mx-auto"
          />
        </div>
