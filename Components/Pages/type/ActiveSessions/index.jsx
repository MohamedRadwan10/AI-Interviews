  ...
  return (
    <div className="container mx-auto p-6">
      <SectionHeader 
        ...
        subTitle={activeSessions.length > 0 ? "You have sessions that need completion" : "No active sessions found"} 
      />
      ...
      {activeSessions.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <MainText 
            ...
            className="text-2xl font-bold text-ui-textMain dark:text-white mb-2" 
          />
          <MainText 
            tag="p" 
            title="You don't have any interviews in progress right now." 
            className="text-ui-textMuted dark:text-ui-muted mb-6" 
          />
          <MainButton 
