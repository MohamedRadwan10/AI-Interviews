    ...
    <div className="min-h-screen flex justify-center items-center dark:bg-dark-primary-1 bg-light-primary py-12 px-4">
      <div className="w-full max-w-2xl px-8 py-8 rounded-lg shadow-md dark:bg-dark-primary-3 bg-light-white">
        <div className="flex items-center justify-center mb-6 w-full gap-2">
          ...
          <Skeleton width="12rem" height="2.5rem" className="dark:!bg-dark-primary-3" />
        </div>
        ...
        <div className="flex flex-col gap-6 mb-8">
          {times(fieldsCount, (i) => (
            <div key={i} className="flex flex-col gap-2">
              ...
              <Skeleton width="100%" height="3.5rem" borderRadius="12px" className="dark:!bg-dark-primary-3" />
            </div>
          ))}
          <Skeleton width="100%" height="3.5rem" borderRadius="30px" className="mt-4 dark:!bg-dark-primary-3" />
        </div>
        {!hideSocial && (
          <div className="flex flex-col gap-6">
            ...
            <div className="flex gap-4">
              <Skeleton width="100%" height="3rem" borderRadius="8px" className="dark:!bg-dark-primary-3" />
              <Skeleton width="100%" height="3rem" borderRadius="8px" className="dark:!bg-dark-primary-3" />
            </div>
          </div>
        )}
        <div className="mt-8 flex justify-center">
          <Skeleton width="15rem" height="1.25rem" className="dark:!bg-dark-primary-3" />
        </div>
      </div>
    </div>
  );
