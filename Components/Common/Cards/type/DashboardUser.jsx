  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
      <div className="bg-white dark:bg-dark-primary-4 rounded-3xl p-6 border border-ui-borderLight dark:border-ui-border shadow-sm flex flex-col items-center justify-center text-center">
        ...
        <MainText className="text-3xl font-extrabold text-ui-textMain dark:text-white mb-1">
          {totalInterviews}
        </MainText>
        <MainText className="text-sm font-medium text-ui-textMuted dark:text-ui-muted">
          Total Interviews
        </MainText>
      </div>
      ...
      <div className="bg-white dark:bg-dark-primary-4 rounded-3xl p-6 border border-ui-borderLight dark:border-ui-border shadow-sm flex items-center justify-between">
        <div className="flex flex-col">
          <MainText className="text-xs font-bold text-brand-primary uppercase tracking-wider mb-2">
            Latest Interview
          </MainText>
          <MainText className="text-sm font-semibold text-ui-textMain dark:text-white mb-1 line-clamp-1">
            {latestRecord?.jobTitle || "No recent interviews"}
          </MainText>
          <MainText className="text-xs text-ui-textMuted dark:text-ui-muted mb-4">
            {latestRecord?.companyName || "-"}
          </MainText>
          {latestRecord?.sessionId && (
            <MainButton 
              className="bg-brand-primary hover:bg-brand-primaryDark text-white px-4 py-2 rounded-xl text-sm font-bold flex items-center gap-2 w-fit"
              onClick={() => navigateTo(`/intelliHire/report/${latestRecord.sessionId}`)}
            >
        ...
        <div className="w-16 h-16 rounded-2xl bg-slate-50 dark:bg-slate-800 flex flex-col items-center justify-center shrink-0">
          <MainText className="text-xl font-bold text-slate-700 dark:text-slate-300">
